...
ApplicationWindow {
    ...
    Map {
        ...
        PositionSource {
            id: positionSource
            nmeaSource: "qrc:///Resources/GPS.txt"
            updateInterval: 1000
        }
        positionDisplay {
            mode: PositionDisplay.Off
    ...
    ServiceInfoTask {
        ...
        onFeatureServiceInfoStatusChanged: {
            ...
            generateGeodatabaseParameters.initialize(featureServiceInfo);
            ...
            if (queryFeaturesStatus === GeodatabaseFeatureTable.QueryFeaturesComplete) {
                ...
                if (queryFeaturesResult.featureCount > 0) {
                    ...
                    if (toolbar.state == "") {
                        ...
                        reviewDate = ratingDateAttr ? new Date(ratingDateAttr) : "NA"
                    }
                    else if (toolbar.state == "analysis") {
    ...
    Rectangle {
        ...
        states: [
            State {
                ...
                PropertyChanges { target: myGPSButton; visible: true }
            },
            State {
                name: "analysis"
                PropertyChanges { target: toolbarGPSButton; visible: false }
    ...
    Image {
        ...
        anchors.horizontalCenter: toolbar.horizontalCenter
        anchors.verticalCenter: toolbar.verticalCenter
        source: positionSource.active ? "qrc:/Resources/gpson.png" : "qrc:/Resources/gps.png"
        visible: false
        MouseArea {
            id: gpsButtonMouseArea
            anchors.fill: parent
            onClicked: {
                if (!positionSource.active) {
                    positionSource.start();
                    map.positionDisplay.showPosition = true;
                    map.positionDisplay.showPing = true;
                    map.positionDisplay.showAccuracy = true;
                    map.positionDisplay.mode = PositionDisplay.Default;
                    myGPSButton.source = "qrc:/Resources/gpson.png"
                }
                else {
                    positionSource.stop();
                    map.positionDisplay.showPosition = false;
                    map.positionDisplay.showPing = false;
                    map.positionDisplay.showAccuracy = false;
                    myGPSButton.source = "qrc:/Resources/gps.png"
                }
            }
        }
    }
